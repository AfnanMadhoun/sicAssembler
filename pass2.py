from pass1 import proglen,startaddress,SYMTAB,opttab,dire,litpool
...
for line in assembly:
	...
	label= ls[9:17].strip()
	operand = ls[26:34].strip()
	if opcode == "START":
		addrlist.append(ls[0:6].strip())
		...
		if opcode in opttab.keys() or opcode in dire:
			...
			if op=="RSUB":
				...
				if operand in SYMTAB.keys():
					...
					objcode.write(code+temp2[2])	
					objcode.write("\n")	
					l.append(code+temp2[2])
